  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: CustomFloatingActionButton(
          ...
          onPressed: () => Get.off(() => const OtherVoterRegistrationForm(),
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        formController.formsList[Get.arguments].firstName == "1"
                            ? CustomTextFormField(
                                validator: (value) {
                                ...
                                controller: formController.firstFormController,
                                labelText: "First Name",
                              )
                            : const SizedBox.shrink(),
                        formController.formsList[Get.arguments].middelName ==
                                "1"
                            ? getheight(context, 0.020)
                            : const SizedBox.shrink(),
                        formController.formsList[Get.arguments].middelName ==
                            ...
                            ? CustomTextFormField(
                                ...
                                controller: formController.middleFormController,
                                labelText: "Middle Name",
                              )
                            : const SizedBox.shrink(),
                        formController.formsList[Get.arguments].surName == "1"
                            ? getheight(context, 0.020)
                            : const SizedBox.shrink(),
                        formController.formsList[Get.arguments].surName == "1"
                            ? CustomTextFormField(
                                ...
                                controller: formController.surFormController,
                                labelText: "Surname",
                              )
                            : const SizedBox.shrink(),
                        formController.formsList[Get.arguments].telephone == "1"
                            ? getheight(context, 0.020)
                            : const SizedBox.shrink(),
                        formController.formsList[Get.arguments].telephone == "1"
                            ? CustomTextFormField(
                                ...
                                controller: formController.teleFormController,
                                labelText: "Telephone Number",
                                textInputType: TextInputType.number,
                              )
                            : const SizedBox.shrink(),
                        formController.formsList[Get.arguments].gender == "1"
                            ? getheight(context, 0.020)
                            : const SizedBox.shrink(),
                        formController.formsList[Get.arguments].gender == "1"
                            ? DropDownWidget(
                                dropValue: formController.genderValue.value,
                                valueList: formController.gender,
                              )
                            : const SizedBox.shrink(),
                        formController.formsList[Get.arguments].address == "1"
                            ? getheight(context, 0.020)
                            : const SizedBox.shrink(),
                        formController.formsList[Get.arguments].address == "1"
                            ...
                            : const SizedBox.shrink(),
                        formController
                                    .formsList[Get.arguments].maritualStatus ==
                                "1"
                            ? getheight(context, 0.020)
                            : const SizedBox.shrink(),
                        formController
                                ...
                                "1"
                            ? DropDownWidget(
                                dropValue: formController.maritualValue.value,
                                valueList: formController.maritual,
                              )
                            : const SizedBox.shrink(),
                        formController.formsList[Get.arguments].dob == "1"
                            ? getheight(context, 0.020)
                            : const SizedBox.shrink(),
                        formController.formsList[Get.arguments].dob == "1"
                            ? CustomTextFormField(
                                onTap: () async {
                                  ...
                                  DateTime? newDate = await showDatePicker(
                                      ...
                                      initialDate: formController.date.value,
                            ...
                            : const SizedBox.shrink(),
                        formController.formsList[Get.arguments].pollUnit == "1"
                            ? getheight(context, 0.020)
                            : const SizedBox.shrink(),
                        formController.formsList[Get.arguments].pollUnit == "1"
                            ? CustomTextFormField(
                                ...
                                controller: formController.pollUnitController,
                                labelText: "Poll Unit",
